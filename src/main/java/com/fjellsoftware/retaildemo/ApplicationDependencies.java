...
import com.fjellsoftware.retaildemo.autogenerated.orm.DatabaseServiceJDBCRetailDemo;
...
public class ApplicationDependencies {
    ...
    ApplicationDependencies(ApplicationConfiguration configuration) {
        ...
        LoppiServiceRetailDemo loppiService = coreDependencies.getLoppiService();
        ...
        this.loginSessionService = createLoginSessionAuthenticationService(databaseServiceJDBC, meta);
    ...
    private LoginSessionService createLoginSessionAuthenticationService(
            DatabaseServiceJDBCRetailDemo DatabaseServiceJDBCRetailDemo, MetaRetailDemo metaRetailDemo){
        return new LoginSessionService(DatabaseServiceJDBCRetailDemo, metaRetailDemo);
    }

    private Domains createDomains(
            LoppiServiceRetailDemo loppiService, LoginSessionService loginSessionService,
