...
public record UpdatePasswordMutationInput(
        @NotNull String previousPassword,
        @NotNull String updatedPassword) {
    public UpdatePasswordMutationInput {
        NullUtils.requireAllNonNull(previousPassword, updatedPassword);
    }
}