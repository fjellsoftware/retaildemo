...
public class GraphQLExecutorCustomer {
    ...
    throws GraphQLRequestException {
        ...
        for (CustomerQueryRootField queryRootField : queryRequest.rootFields()) {
            GraphQLExecutableQueryField queryAfterAccessControl = switch (queryRootField){
                case CustomerIntrospectionRootField introspectionQuery -> introspectionQuery.queryField();
                case CustomerDatabaseQueryRootField databaseQuery -> applyAccessControlToDatabaseQuery(databaseQuery, userInfo);
            };
    ...
    private GraphQLExecutableQueryField applyAccessControlToDatabaseQuery(
            CustomerDatabaseQueryRootField databaseQuery, UserInfo userInfo) throws GraphQLRequestException {
        return switch (databaseQuery) {
        ...
        case ProductsQueryField ignored -> databaseQuery.queryField();
